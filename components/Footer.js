      ...
      <div className="mx-auto w-full max-w-screen-xl p-2 py-6">
        ...
        <div className="flex flex-col items-center text-center md:flex-row md:justify-between md:text-left">
          ...
          <div className="mb-4 md:mb-0">
            <Link 
              href="/"
              className="flex flex-row items-center md:flex-row md:items-center space-y-2 md:space-y-2 md:space-x-3">
            ...
            <div className="flex justify-center mt-5 space-x-5">
              ...
              <Link 
                href="#"
                className="text-gray-300 hover:bg-gradient-to-r from-[#833ab4] via-[#fd1d1d] to-[#fcb045] hover:rounded-lg">
                <svg
                    className="w-6 h-6"
                    aria-hidden="true"
                    xmlns="http://www.w3.org/2000/svg"
